...
create_sim_survey_dietcomp <- function(atlmod,fitstart=NULL,fitend=NULL,saveToData=T) {
  ...
  all_diets <- atlantisom::read_savedsurvs(file.path(d.name,v.name), 'survDiet')
