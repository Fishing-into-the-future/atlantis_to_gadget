...
create_sim_fishery_lencomp_subannual <- function(atlmod,fitstart=NULL,fitend=NULL,saveToData=T) {
  ...
  if (saveToData) {
    ...
    usethis::use_data(simFisheryLencompSubannual, overwrite = TRUE)
  }
  
  return(simFisheryLencompSubannual)
